...
_The code below on Stan is also available as an [`RPub webpage`](https://rpubs.com/RobertMylesMc/Bayesian-IRT-ideal-points-with-Stan-in-R), if you'd rather work through the examples than read all of the post._
