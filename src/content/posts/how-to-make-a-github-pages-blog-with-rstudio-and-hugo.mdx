...
So I liked the sustain theme that I had chosen, but after seeing that [Julia Silge](https://juliasilge.com/) writes her lovely GitHub pages blog in R Markdown, I thought, 'huh? That would be _much_ easier'. Yes, and no. Big no.
