...
<BlockMath math="y_{ijk} = \beta_j \theta_{ik} - \alpha_j," />

where _i_ is an index of voters, _j_ an index of votes, and _k_ an index of topics. <InlineMath math="\theta_{ik}"/> is our main object of interest: the ideal point of MEP _i_ on topic _k_.
