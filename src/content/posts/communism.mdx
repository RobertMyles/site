...
As usual, the Economist has some of the best visualizations on the subject. We could [recreate this in R](https://www.robertmylesmcdonnell.com/content/posts/re-creating-plots-from-the-economist-in-r/), but let's just use the original. It's from [this](http://www.economist.com/blogs/graphicdetail/2015/10/daily-chart-comparing-eastern-and-western-germany) article.

![](http://i.imgur.com/lqnmr6y.png)

Well, one thing that we can be sure about is that the commies cracked some great [jokes](http://www.prospectmagazine.co.uk/features/communist-jokes).
...
[^2]: In an old-school [Scottish sense](http://deirdremccloskey.org/academics/index.php).
