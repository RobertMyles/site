...
date: "2020-04-26"
featuredImage: "images/knitrrmark.png"
---
...
Since these will be `TRUE` or `FALSE` depending on which output you're `render`ing to, we can include these in the code chunk like so:
