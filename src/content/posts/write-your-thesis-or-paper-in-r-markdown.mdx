...
[^1]: For example, [this cheatsheet](http://markdown-guide.readthedocs.org/en/latest/basics.html)[↩](#a1)
[^2]: In my experience, I think you’re just going to end up editing these in Word anyway so I don’t know that it’s worth the bother to do in RStudio. You can if you want, I suppose.[↩](#a2)
[^3]: I’m including extra things here that I used over the process of making the thesis pdf, but it wasn’t what I used exactly in the end. I had some problems, that I can’t recall right now, with rendering bibliographical items so I switched to the default LaTeX renderer, pdflatex. Using this means you can’t use other fonts, like the Linux Libertine font above.[↩](#a3)
