...
date: "2017-07-28"
featuredImage: "images/prisonbrief-2.png"
---

My good friend [Danilo Freire](http://danilofreiregithub.io) and I have just finished a little R data package, called [prisonbrief](http://danilofreire.com/prisonbrief/). We hope that it will be useful for R users, particularly researchers in the area, since this is still a much understudied topic. Why does prison population change? In many countries, it is rising, and has been for some time, and the determinants of this rise are still not well understood. All the data in the package come from the fantastic [World Prison Brief](http://www.prisonstudies.org/) website -- we thank them for making these data available. You can contribute to the project [here](http://www.prisonstudies.org/about-us).
