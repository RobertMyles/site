...
Here's a quick example of utilising a Python script in R with the use of reticulate. 
```{r}
library(dplyr)
library(reticulate)
```
...
So here's a tiny fake dataet that illustrates the issue: 
```{r}
df <- tibble(
  random_id = sample(letters, 10),
  timestamp = c(1537363730375, 1537363680645, 1537363720707, 1537363740836, 1537363740176, 1537363700649, 1537363780495, 1537363730636, 1537363730041, 1537363767311)
)
