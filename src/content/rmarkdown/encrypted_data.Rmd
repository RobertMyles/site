...
Then, with astoundingly ugly code, we'll sum the encrypted spend and put the results in this list. We use a for-loop (I know), cos that's how I'm rolling right now. 
```{r}
